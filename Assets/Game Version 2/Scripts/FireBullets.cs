...
public class FireBullets : MonoBehaviour
{
    ...
    private Vector2 bulletMoveDirection; // Direction for bullet movement (not currently used)
    ...
    private void Fire()
    {
        // Calculate the step between each bullet's angle based on the total angle range
        ...
        {
            // Calculate the direction of the bullet using trigonometric functions
